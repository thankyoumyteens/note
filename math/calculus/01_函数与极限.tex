...
\begin{flushleft}
	...
	2、降幂公式：$cos^2\alpha=\frac{1+cos2\alpha}{2}$\\
	3、降幂公式：$sin^2\alpha=\frac{1-cos2\alpha}{2}$\\
	4、降幂公式：$tan^2\alpha=\frac{1-cos2\alpha}{1+cos2\alpha}$\\
	5、$cosx=sin(x+\frac{\pi}{2})$\\
	
	\subsection{拆开分式}
	1、$\frac{c}{a\times b}=
	\frac{c}{b-a}(\frac{1}{a}-\frac{1}{b})$，其中$b>a$\\
	2、$\frac{x}{1+x}=1-\frac{1}{1+x}$\\
