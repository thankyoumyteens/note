...
& {\color{Green} // 没有分母也没有根号，提取} \\
& {\color{Green} // 提取出x^2} \\
& = \lim_{x \to \infty} x^2 \left [ \frac{1}{x} - \ln \left ( 1 + \frac{1}{x} \right ) \right ] \\
& {\color{Green} // 现在变成了无穷大乘零型} \\
& {\color{Green} // 无穷大留下，把无穷小放到分母上，变成无穷比无穷型} \\
& = \lim_{x \to \infty} \frac{\frac{1}{x} - \ln \left ( 1 + \frac{1}{x} \right )}{\frac{1}{x^2}} \\
& {\color{Green} // 换元，令t = \frac{1}{x}} \\
