...
public class MultiProviderChatClientConfig {
    ...
    @Bean
    @Primary
    public ChatClient qwenChatClient(AiProviderProperties properties) {
        var provider = properties.getRequiredProvider("qwen");
        ...
        // Qwen 走 OpenAI-compatible 协议，所以使用 OpenAiChatModel。
