...
寻址时每 1 位都代表一个地址, 在 32 位系统中, 可以寻址 2^32=4294967296 个地址, 而操作系统使用内存的最小单位是字节(一个内存地址对应 1 个字节的内存空间), 所以 32 位操作系统可以使用 4294967296\*1B=4GB 内存。可用的地址范围: 00000000000000000000000000000000 ~ 11111111111111111111111111111111
