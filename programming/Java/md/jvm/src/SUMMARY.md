...
- [编译与优化](./java_compile/compile.md)
  - [前端编译与优化](./java_compile/front_end.md)
    - [Javac编译器](./java_compile/javac.md)
    - [泛型](./java_compile/parameterized_type.md)
  - [后端编译与优化](./java_compile/back_end.md)
    - [即时编译器](./java_compile/jit.md)
    - [提前编译器](./java_compile/aot.md)
    - [方法内联](./java_compile/method_inlining.md)
    - [逃逸分析](./java_compile/escape_analysis.md)
    - [公共子表达式消除](./java_compile/cse.md)
    - [数组边界检查消除](./java_compile/abce.md)

- [并发](./concurrency/concurrency.md)
  - [缓存一致性](./concurrency/cache.md)
  - [Java内存模型](./concurrency/jmm.md)
  - [volatile关键字](./concurrency/volatile.md)
  - [线程](./concurrency/thread.md)
  - [协程](./concurrency/coroutine.md)
  - [线程安全](./concurrency/synchronization.md)
  - [锁优化](./concurrency/lock.md)
...
- [JDK可视化工具](./tools/gui/jdk_tools.md)
...
- [字节码指令](./is/is.md)
  ...
  - [比较指令](./is/cmp.md)
  - [类型转换指令](./is/cast.md)
  - [类型检查指令](./is/check_cast.md)
  - [对象操作指令](./is/obj.md)
  - [数组操作指令](./is/array_obj.md)
  - [操作数栈指令](./is/stack.md)
  - [跳转指令](./is/jump.md)
  - [方法调用指令](./is/invoke.md)
  - [方法返回指令](./is/return.md)
