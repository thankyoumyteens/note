...
### 1）怎么确认是 Full GC 导致吞吐量下降和 P99 飙高的？
...
### 2）你说 Old 区回收效果不好、晋升速率快，是怎么看出来的？
...
### 3）你提到用 `jmap`、堆 dump，具体是怎么定位到“临时对象很多”的？
...
### 5）那如果下次遇到 Full GC 频繁，但堆看起来并没有被塞满，或者对象增长没那么夸张，你会从哪些方向排查？
