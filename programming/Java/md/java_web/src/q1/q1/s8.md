...
## 为什么要用 nacos 做注册中心，而不用 zookeeper

- 性能
  - Nacos 采用轻量级设计，通信使用简单的 HTTP 协议，避免了复杂的协议处理和消息传递，降低了系统开销，提高了响应速度
  - ZooKeeper 使用自定义协议，处理逻辑更复杂
- 更丰富的服务管理功能
  - Nacos 除了基本的服务注册与发现功能外，还提供了配置中心、服务元数据管理、服务健康监测等功能
  - ZooKeeper 主要侧重于提供分布式协调服务，服务管理功能单一
- 维护成本
  - Nacos 提供了开箱即用的功能，部署和配置过程相对简单
  - ZooKeeper 部署和配置相对复杂, 在集群环境下，还需要进行复杂的配置和调优
