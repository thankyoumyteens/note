...
### 第 5C 课：让 AI 追踪一次请求链路，并生成模块级请求链路文档
...
### 第 6C 课：把 Plan-Then-Act 作为全局开发规则
...
### 第 8A 课：spec-workflow-mcp 工具化与 MCP 工作流基础
...
### 第 8B 课：用 spec-workflow-mcp 完成一个小功能闭环
...
### 第 8C 课：spec-workflow-mcp 中的需求变更管理
...
### 第 13 课：Commands / Skills / Hooks / MCP 的分工
...
### 第 13C 课：MCP / Skills / Hooks 组合工作流
...
### 第 14C 课：AI Diff Review：只审查本次改动
...
### 第 14D 课：Definition of Done：AI 输出验收标准
...
### 第 16A 课：Project Memory Handoff 与项目记忆系统治理
...
### 第 17A 课：MCP / Skills / Hooks 组合项目实践
