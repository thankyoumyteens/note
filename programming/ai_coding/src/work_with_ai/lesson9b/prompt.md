...
请不要手写普通 specs/ 目录。
请优先使用 spec-workflow MCP 提供的工具创建和推进 feature spec。

背景：
当前项目是 ai-doc-summary，已经完成：
1. POST /api/documents 文档保存功能
2. GET /api/documents/{id} 文档查询功能
3. 第 8～9 课已经手写过 specs/document-query/
4. 第 9A 课已经安装 / 配置 spec-workflow-mcp
...
4. 生成或完善 design。
5. 生成或完善 tasks。
6. 如果工具有 approval 流程，请按工具要求完成审批或说明需要人工确认。
7. 按 tasks 逐项实现。
